...
<head>
    ...
    <meta name="description" content="@yield('meta_description', $schoolProfile?->description ?? 'Website profil PKBM Al Falah Sumur Batu.')">
    <title>@yield('title', $schoolProfile?->school_name ?? 'PKBM Al Falah Sumur Batu')</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="publicNavbar">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{ $homeUrl }}#profil">Profil</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ $homeUrl }}#visi-misi">Visi Misi</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ $homeUrl }}#program">Program</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ $homeUrl }}#sejarah">Sejarah</a></li>
            ...
            <div class="row g-4">
                <div class="col-lg-5">
                    <div class="footer-brand">
                        ...
                        <div>
                            <h2>{{ $schoolName }}</h2>
                            <p>{{ $schoolProfile?->tagline ?: 'Pendidikan yang ramah, terarah, dan mendukung perkembangan peserta didik.' }}</p>
                        </div>
                    </div>
                </div>
