...
@section('title', ($schoolProfile?->school_name ?? 'PKBM Al Falah Sumur Batu').' | Website Resmi')

@section('content')
    @php
        $schoolName = $schoolProfile?->school_name ?: 'PKBM Al Falah Sumur Batu';
        $tagline = $schoolProfile?->tagline ?: 'Pendidikan yang ramah dan terarah untuk masa depan yang lebih baik';
        $schoolDescription = $schoolProfile?->description ?: 'Lembaga pendidikan yang mendukung perkembangan pengetahuan, karakter, dan keterampilan peserta didik.';
    ...
    >
        ...
        <div class="container hero-content">
            ...
            <p class="hero-description">{{ $schoolDescription }}</p>
                            ...
                            <div>
                                ...
                                <dd>
                                    @if ($schoolProfile?->phone)
                                        <a href="tel:{{ $phoneDigits }}">{{ $schoolProfile->phone }}</a>
                                    @else
                                        Belum tersedia
                                    @endif
                                </dd>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="contact-list">
                        <div class="contact-item">
                            <span class="contact-icon" aria-hidden="true">A</span>
                            <div>
                        ...
                        <div class="contact-item">
                            <span class="contact-icon" aria-hidden="true">E</span>
                            <div>
                                <strong>Email</strong>
                    ...
                    <div class="map-card">
                        ...
                        @else
                            <div class="map-placeholder">
                                ...
                                <p>{{ $schoolProfile?->address ?: 'Peta lokasi akan ditampilkan setelah data tersedia.' }}</p>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('#publicNavbar .nav-link, #publicNavbar .nav-contact-button')
                .forEach((link) => {
